...
public record ClienteRequestDTO (UUID id, @NotNull Corretor usuario, Endereco endereco, Tipo tipo, List<Caracteristica> caracteristicas, String bairro, @NotBlank String nome, @NotBlank String email, @NotBlank String telefone, String cpf, OffsetDateTime excluidoEm) {}
